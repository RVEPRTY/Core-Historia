...
// ================================
// CODING CLASS STATUS CARD
// ================================

// CHANGE ONLY THIS DATE & TIME (UTC recommended)
const classDate = new Date("2026-02-05T20:00:00Z");
...
// Show scheduled time in user's local timezone
timeEl.textContent =
  "Scheduled for " +
  classDate.toLocaleString([], {
    dateStyle: "medium",
    timeStyle: "short"
  });
...
function updateClassStatus() {
  ...
  if (diff <= 0) {
    ...
    stageLink.style.display = "inline-block";
    return;
  }
  ...
  statusEl.textContent = `Starts in ${hours}h ${minutes}m`;
  stageLink.style.display = "none";
}
